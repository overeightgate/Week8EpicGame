...
string[] weapon = { "wand", "gun", "bat", "bomb", "brick" };


//string[] heroes = { "Ironman", "Flash", "Hawkeye", "Batman" };
//string[] villains = { "Ultron", "Reverse Flash", "Thanos", "Joker" };
...
if(heroHP > 0)
{
    Console.WriteLine($"The {hero} saves the day!");
}
else if(villainHP > 0)
{
